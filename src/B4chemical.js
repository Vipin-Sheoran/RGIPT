...
if(type[6]===days[0]){
  if(disabled===false){
    ...
    if(P3MfacultyAt9[0]===prof[1]||C3MfacultyAt9[0]===prof[1]||C3MfacultyAt9[0]===prof3[0]||CMfacultyAt9===prof3[1]||C3MfacultyAt9[0]==='Dr. ASKS'||CMfacultyAt9[0]===prof3[0]){
       numAt9=[]
    }
    if(P3MfacultyAt10[0]===prof[1]||C3MfacultyAt10[0]===prof[1]||C3MfacultyAt10[0]===prof3[0]||CMfacultyAt10===prof3[1]||C3MfacultyAt10[0]==='Dr. ASKS'){
      numAt10=[]
   }
   if(P3MfacultyAt11[0]===prof[1]||C3MfacultyAt11[0]===prof[1]||C3MfacultyAt11[0]===prof3[0]||CMfacultyAt11===prof3[1]||C3MfacultyAt11[0]==='Dr. ASKS'){
    numAt11=[]
 }
 if(P3MfacultyAt12[0]===prof[1]||C3MfacultyAt12[0]===prof[1]||C3MfacultyAt12[0]===prof3[0]||CMfacultyAt12===prof3[1]||C3MfacultyAt12[0]==='Dr. ASKS'){
  numAt12=[]
}
if(P3MfacultyAt03[0]===prof[1]||C3MfacultyAt03[0]===prof[1]||C3MfacultyAt03[0]===prof3[0]||CMfacultyAt03===prof3[1]||C3MfacultyAt03[0]==='Dr. ASKS'){
  numAt03=[]
}
if(P3MfacultyAt04[0]===prof[1]||C3MfacultyAt04[0]===prof[1]||C3MfacultyAt04[0]===prof3[0]||CMfacultyAt04===prof3[1]||C3MfacultyAt04[0]==='Dr. ASKS'){
  numAt04=[]
}
if(P3MfacultyAt05[0]===prof[1]||C3MfacultyAt05[0]===prof[1]||C3MfacultyAt05[0]===prof3[0]||CMfacultyAt05===prof3[1]||C3MfacultyAt05[0]==='Dr. ASKS'){
  numAt05=[]
}


if(P4MfacultyAt9.length>0){
  if(P4MfacultyAt9[0]==='Dr. UDD'){
    numAt9=['Dr. UDD']
  }else if(P4MfacultyAt9[0]==='Dr. Biswas'){
    numAt9=['Dr. Biswas']
  }else{
...
if(P4MfacultyAt10.length>0){
    if(P4MfacultyAt10[0]==='Dr. UDD'){
      numAt10=['Dr. UDD']
    }else if(P4MfacultyAt10[0]==='Dr. Biswas'){
      numAt10=['Dr. Biswas']
    }else{
  ...
  if(P4MfacultyAt11.length>0){
    if(P4MfacultyAt11[0]==='Dr. UDD'){
      numAt11=['Dr. UDD']
    }else if(P4MfacultyAt11[0]==='Dr. Biswas'){
      numAt11=['Dr. Biswas']
    }else{
  ...
  if(P4MfacultyAt12.length>0){
    if(P4MfacultyAt12[0]==='Dr. UDD'){
      numAt12=['Dr. UDD']
    }else if(P4MfacultyAt12[0]==='Dr. Biswas'){
      numAt12=['Dr. Biswas']
    }else{
  ...
  if(P4MfacultyAt03.length>0){
    if(P4MfacultyAt03[0]==='Dr. UDD'){
      numAt03=['Dr. UDD']
    }else if(P4MfacultyAt03[0]==='Dr. Biswas'){
      numAt03=['Dr. Biswas']
    }else{
  ...
  if(P4MfacultyAt04.length>0){
    if(P4MfacultyAt04[0]==='Dr. UDD'){
      numAt04=['Dr. UDD']
    }else if(P4MfacultyAt04[0]==='Dr. Biswas'){
      numAt04=['Dr. Biswas']
    }else{
  ...
  if(P4MfacultyAt05.length>0){
    if(P4MfacultyAt05[0]==='Dr. UDD'){
      numAt05=['Dr. UDD']
    }else if(P4MfacultyAt05[0]==='Dr. Biswas'){
      numAt05=['Dr. Biswas']
    }else{
    ...
    numAt9=[C4MfacultyAt9[0]]    
    numAt10=[C4MfacultyAt10[0]]
    numAt11=[C4MfacultyAt11[0]]
    numAt12=[C4MfacultyAt12[0]]
    numAt03=[C4MfacultyAt03[0]]
    numAt04=[C4MfacultyAt04[0]]
    numAt05=[C4MfacultyAt05[0]]
  }
}
...
if(type[6]===days[1]){
  if(disabled===false){
    ...
    if(P3TfacultyAt9[0]===prof[1]||C3TfacultyAt9[0]===prof[1]||C3TfacultyAt9[0]===prof3[0]||CTfacultyAt9===prof3[1]||C3TfacultyAt9[0]==='Dr. ASKS'||CTfacultyAt9[0]===prof3[0]){
       numAt9=[]
    }
    if(P3TfacultyAt10[0]===prof[1]||C3TfacultyAt10[0]===prof[1]||C3TfacultyAt10[0]===prof3[0]||CTfacultyAt10===prof3[1]||C3TfacultyAt10[0]==='Dr. ASKS'){
      numAt10=[]
   }
   if(P3TfacultyAt11[0]===prof[1]||C3TfacultyAt11[0]===prof[1]||C3TfacultyAt11[0]===prof3[0]||CTfacultyAt11===prof3[1]||C3TfacultyAt11[0]==='Dr. ASKS'){
    numAt11=[]
 }
 if(P3TfacultyAt12[0]===prof[1]||C3TfacultyAt12[0]===prof[1]||C3TfacultyAt12[0]===prof3[0]||CTfacultyAt12===prof3[1]||C3TfacultyAt12[0]==='Dr. ASKS'){
  numAt12=[]
}
if(P3TfacultyAt03[0]===prof[1]||C3TfacultyAt03[0]===prof[1]||C3TfacultyAt03[0]===prof3[0]||CTfacultyAt03===prof3[1]||C3TfacultyAt03[0]==='Dr. ASKS'){
  numAt03=[]
}
if(P3TfacultyAt04[0]===prof[1]||C3TfacultyAt04[0]===prof[1]||C3TfacultyAt04[0]===prof3[0]||CTfacultyAt04===prof3[1]||C3TfacultyAt04[0]==='Dr. ASKS'){
  numAt04=[]
}
if(P3TfacultyAt05[0]===prof[1]||C3TfacultyAt05[0]===prof[1]||C3TfacultyAt05[0]===prof3[0]||CTfacultyAt05===prof3[1]||C3TfacultyAt05[0]==='Dr. ASKS'){
  numAt05=[]
}


if(P4TfacultyAt9.length>0){
  if(P4TfacultyAt9[0]==='Dr. UDD'){
    numAt9=['Dr. UDD']
  }else if(P4TfacultyAt9[0]==='Dr. Biswas'){
    numAt9=['Dr. Biswas']
  }else{
    numAt9= prof3.filter((item) => { 
        return TfacultyAt9.indexOf(item) === -1 
...
if(P4TfacultyAt10.length>0){
    if(P4TfacultyAt10[0]==='Dr. UDD'){
      numAt10=['Dr. UDD']
    }else if(P4TfacultyAt10[0]==='Dr. Biswas'){
      numAt10=['Dr. Biswas']
    }else{
      numAt10= prof3.filter((item) => { 
          return TfacultyAt10.indexOf(item) === -1 
  ...
  if(P4TfacultyAt11.length>0){
    if(P4TfacultyAt11[0]==='Dr. UDD'){
      numAt11=['Dr. UDD']
    }else if(P4TfacultyAt11[0]==='Dr. Biswas'){
      numAt11=['Dr. Biswas']
    }else{
      numAt11= prof3.filter((item) => { 
          return TfacultyAt11.indexOf(item) === -1 
  ...
  if(P4TfacultyAt12.length>0){
    if(P4TfacultyAt12[0]==='Dr. UDD'){
      numAt12=['Dr. UDD']
    }else if(P4TfacultyAt12[0]==='Dr. Biswas'){
      numAt12=['Dr. Biswas']
    }else{
      numAt12= prof3.filter((item) => { 
          return TfacultyAt12.indexOf(item) === -1 
  ...
  if(P4TfacultyAt03.length>0){
    if(P4TfacultyAt03[0]==='Dr. UDD'){
      numAt03=['Dr. UDD']
    }else if(P4TfacultyAt03[0]==='Dr. Biswas'){
      numAt03=['Dr. Biswas']
    }else{
      numAt03= prof3.filter((item) => { 
          return TfacultyAt03.indexOf(item) === -1 
  ...
  if(P4TfacultyAt04.length>0){
    if(P4TfacultyAt04[0]==='Dr. UDD'){
      numAt04=['Dr. UDD']
    }else if(P4TfacultyAt04[0]==='Dr. Biswas'){
      numAt04=['Dr. Biswas']
    }else{
      numAt04= prof3.filter((item) => { 
          return TfacultyAt04.indexOf(item) === -1 
  ...
  if(P4TfacultyAt05.length>0){
    if(P4TfacultyAt05[0]==='Dr. UDD'){
      numAt05=['Dr. UDD']
    }else if(P4TfacultyAt05[0]==='Dr. Biswas'){
      numAt05=['Dr. Biswas']
    }else{
      numAt05= prof3.filter((item) => { 
          return TfacultyAt05.indexOf(item) === -1 
    ...
    numAt9=[C4TfacultyAt9[0]]    
    numAt10=[C4TfacultyAt10[0]]
    numAt11=[C4TfacultyAt11[0]]
    numAt12=[C4TfacultyAt12[0]]
    numAt03=[C4TfacultyAt03[0]]
    numAt04=[C4TfacultyAt04[0]]
    numAt05=[C4TfacultyAt05[0]]
  }
// console.log(num)
...
if(type[6]===days[2]){
  if(disabled===false){
    ...
    if(P3WfacultyAt9[0]===prof[1]||C3WfacultyAt9[0]===prof[1]||C3WfacultyAt9[0]===prof3[0]||CWfacultyAt9===prof3[1]||C3WfacultyAt9[0]==='Dr. ASKS'||CWfacultyAt9[0]===prof3[0]){
       numAt9=[]
    }
    if(P3WfacultyAt10[0]===prof[1]||C3WfacultyAt10[0]===prof[1]||C3WfacultyAt10[0]===prof3[0]||CWfacultyAt10===prof3[1]||C3WfacultyAt10[0]==='Dr. ASKS'){
      numAt10=[]
   }
   if(P3WfacultyAt11[0]===prof[1]||C3WfacultyAt11[0]===prof[1]||C3WfacultyAt11[0]===prof3[0]||CWfacultyAt11===prof3[1]||C3WfacultyAt11[0]==='Dr. ASKS'){
    numAt11=[]
 }
 if(P3WfacultyAt12[0]===prof[1]||C3WfacultyAt12[0]===prof[1]||C3WfacultyAt12[0]===prof3[0]||CWfacultyAt12===prof3[1]||C3WfacultyAt12[0]==='Dr. ASKS'){
  numAt12=[]
}
if(P3WfacultyAt03[0]===prof[1]||C3WfacultyAt03[0]===prof[1]||C3WfacultyAt03[0]===prof3[0]||CWfacultyAt03===prof3[1]||C3WfacultyAt03[0]==='Dr. ASKS'){
  numAt03=[]
}
if(P3WfacultyAt04[0]===prof[1]||C3WfacultyAt04[0]===prof[1]||C3WfacultyAt04[0]===prof3[0]||CWfacultyAt04===prof3[1]||C3WfacultyAt04[0]==='Dr. ASKS'){
  numAt04=[]
}
if(P3WfacultyAt05[0]===prof[1]||C3WfacultyAt05[0]===prof[1]||C3WfacultyAt05[0]===prof3[0]||CWfacultyAt05===prof3[1]||C3WfacultyAt05[0]==='Dr. ASKS'){
  numAt05=[]
}


if(P4WfacultyAt9.length>0){
  if(P4WfacultyAt9[0]==='Dr. UDD'){
    numAt9=['Dr. UDD']
  }else if(P4WfacultyAt9[0]==='Dr. Biswas'){
    numAt9=['Dr. Biswas']
  }else{
    numAt9= prof3.filter((item) => { 
        return WfacultyAt9.indexOf(item) === -1 
...
if(P4WfacultyAt10.length>0){
    if(P4WfacultyAt10[0]==='Dr. UDD'){
      numAt10=['Dr. UDD']
    }else if(P4WfacultyAt10[0]==='Dr. Biswas'){
      numAt10=['Dr. Biswas']
    }else{
      numAt10= prof3.filter((item) => { 
          return WfacultyAt10.indexOf(item) === -1 
  ...
  if(P4WfacultyAt11.length>0){
    if(P4WfacultyAt11[0]==='Dr. UDD'){
      numAt11=['Dr. UDD']
    }else if(P4WfacultyAt11[0]==='Dr. Biswas'){
      numAt11=['Dr. Biswas']
    }else{
      numAt11= prof3.filter((item) => { 
          return WfacultyAt11.indexOf(item) === -1 
  ...
  if(P4WfacultyAt12.length>0){
    if(P4WfacultyAt12[0]==='Dr. UDD'){
      numAt12=['Dr. UDD']
    }else if(P4WfacultyAt12[0]==='Dr. Biswas'){
      numAt12=['Dr. Biswas']
    }else{
      numAt12= prof3.filter((item) => { 
          return WfacultyAt12.indexOf(item) === -1 
  ...
  if(P4WfacultyAt03.length>0){
    if(P4WfacultyAt03[0]==='Dr. UDD'){
      numAt03=['Dr. UDD']
    }else if(P4WfacultyAt03[0]==='Dr. Biswas'){
      numAt03=['Dr. Biswas']
    }else{
      numAt03= prof3.filter((item) => { 
          return WfacultyAt03.indexOf(item) === -1 
  ...
  if(P4WfacultyAt04.length>0){
    if(P4WfacultyAt04[0]==='Dr. UDD'){
      numAt04=['Dr. UDD']
    }else if(P4WfacultyAt04[0]==='Dr. Biswas'){
      numAt04=['Dr. Biswas']
    }else{
      numAt04= prof3.filter((item) => { 
          return WfacultyAt04.indexOf(item) === -1 
  ...
  if(P4WfacultyAt05.length>0){
    if(P4WfacultyAt05[0]==='Dr. UDD'){
      numAt05=['Dr. UDD']
    }else if(P4WfacultyAt05[0]==='Dr. Biswas'){
      numAt05=['Dr. Biswas']
    }else{
      numAt05= prof3.filter((item) => { 
          return WfacultyAt05.indexOf(item) === -1 
    ...
    numAt9=[C4WfacultyAt9[0]]    
    numAt10=[C4WfacultyAt10[0]]
    numAt11=[C4WfacultyAt11[0]]
    numAt12=[C4WfacultyAt12[0]]
    numAt03=[C4WfacultyAt03[0]]
    numAt04=[C4WfacultyAt04[0]]
    numAt05=[C4WfacultyAt05[0]]
  }
}
...
if(type[6]===days[3]){
  if(disabled===false){
    ...
    if(P3THfacultyAt9[0]===prof[1]||C3THfacultyAt9[0]===prof[1]||C3THfacultyAt9[0]===prof3[0]||CTHfacultyAt9===prof3[1]||C3THfacultyAt9[0]==='Dr. ASKS'||CTHfacultyAt9[0]===prof3[0]){
       numAt9=[]
    }
    if(P3THfacultyAt10[0]===prof[1]||C3THfacultyAt10[0]===prof[1]||C3THfacultyAt10[0]===prof3[0]||CTHfacultyAt10===prof3[1]||C3THfacultyAt10[0]==='Dr. ASKS'){
      numAt10=[]
   }
   if(P3THfacultyAt11[0]===prof[1]||C3THfacultyAt11[0]===prof[1]||C3THfacultyAt11[0]===prof3[0]||CTHfacultyAt11===prof3[1]||C3THfacultyAt11[0]==='Dr. ASKS'){
    numAt11=[]
 }
 if(P3THfacultyAt12[0]===prof[1]||C3THfacultyAt12[0]===prof[1]||C3THfacultyAt12[0]===prof3[0]||CTHfacultyAt12===prof3[1]||C3THfacultyAt12[0]==='Dr. ASKS'){
  numAt12=[]
}
if(P3THfacultyAt03[0]===prof[1]||C3THfacultyAt03[0]===prof[1]||C3THfacultyAt03[0]===prof3[0]||CTHfacultyAt03===prof3[1]||C3THfacultyAt03[0]==='Dr. ASKS'){
  numAt03=[]
}
if(P3THfacultyAt04[0]===prof[1]||C3THfacultyAt04[0]===prof[1]||C3THfacultyAt04[0]===prof3[0]||CTHfacultyAt04===prof3[1]||C3THfacultyAt04[0]==='Dr. ASKS'){
  numAt04=[]
}
if(P3THfacultyAt05[0]===prof[1]||C3THfacultyAt05[0]===prof[1]||C3THfacultyAt05[0]===prof3[0]||CTHfacultyAt05===prof3[1]||C3THfacultyAt05[0]==='Dr. ASKS'){
  numAt05=[]
}


if(P4THfacultyAt9.length>0){
  if(P4THfacultyAt9[0]==='Dr. UDD'){
    numAt9=['Dr. UDD']
  }else if(P4THfacultyAt9[0]==='Dr. Biswas'){
    numAt9=['Dr. Biswas']
  }else{
    numAt9= prof3.filter((item) => { 
        return THfacultyAt9.indexOf(item) === -1 
...
if(P4THfacultyAt10.length>0){
    if(P4THfacultyAt10[0]==='Dr. UDD'){
      numAt10=['Dr. UDD']
    }else if(P4THfacultyAt10[0]==='Dr. Biswas'){
      numAt10=['Dr. Biswas']
    }else{
      numAt10= prof3.filter((item) => { 
          return THfacultyAt10.indexOf(item) === -1 
  ...
  if(P4THfacultyAt11.length>0){
    if(P4THfacultyAt11[0]==='Dr. UDD'){
      numAt11=['Dr. UDD']
    }else if(P4THfacultyAt11[0]==='Dr. Biswas'){
      numAt11=['Dr. Biswas']
    }else{
      numAt11= prof3.filter((item) => { 
          return THfacultyAt11.indexOf(item) === -1 
  ...
  if(P4THfacultyAt12.length>0){
    if(P4THfacultyAt12[0]==='Dr. UDD'){
      numAt12=['Dr. UDD']
    }else if(P4THfacultyAt12[0]==='Dr. Biswas'){
      numAt12=['Dr. Biswas']
    }else{
      numAt12= prof3.filter((item) => { 
          return THfacultyAt12.indexOf(item) === -1 
  ...
  if(P4THfacultyAt03.length>0){
    if(P4THfacultyAt03[0]==='Dr. UDD'){
      numAt03=['Dr. UDD']
    }else if(P4THfacultyAt03[0]==='Dr. Biswas'){
      numAt03=['Dr. Biswas']
    }else{
      numAt03= prof3.filter((item) => { 
          return THfacultyAt03.indexOf(item) === -1 
  ...
  if(P4THfacultyAt04.length>0){
    if(P4THfacultyAt04[0]==='Dr. UDD'){
      numAt04=['Dr. UDD']
    }else if(P4THfacultyAt04[0]==='Dr. Biswas'){
      numAt04=['Dr. Biswas']
    }else{
      numAt04= prof3.filter((item) => { 
          return THfacultyAt04.indexOf(item) === -1 
  ...
  if(P4THfacultyAt05.length>0){
    if(P4THfacultyAt05[0]==='Dr. UDD'){
      numAt05=['Dr. UDD']
    }else if(P4THfacultyAt05[0]==='Dr. Biswas'){
      numAt05=['Dr. Biswas']
    }else{
      numAt05= prof3.filter((item) => { 
          return THfacultyAt05.indexOf(item) === -1 
    ...
    numAt9=[C4THfacultyAt9[0]]    
    numAt10=[C4THfacultyAt10[0]]
    numAt11=[C4THfacultyAt11[0]]
    numAt12=[C4THfacultyAt12[0]]
    numAt03=[C4THfacultyAt03[0]]
    numAt04=[C4THfacultyAt04[0]]
    numAt05=[C4THfacultyAt05[0]]
  }
}
...
if(type[6]===days[4]){
  if(disabled===false){
    ...
    if(P3FfacultyAt9[0]===prof[1]||C3FfacultyAt9[0]===prof[1]||C3FfacultyAt9[0]===prof3[0]||CFfacultyAt9===prof3[1]||C3FfacultyAt9[0]==='Dr. ASKS'||CFfacultyAt9[0]===prof3[0]){
       numAt9=[]
    }
    if(P3FfacultyAt10[0]===prof[1]||C3FfacultyAt10[0]===prof[1]||C3FfacultyAt10[0]===prof3[0]||CFfacultyAt10===prof3[1]||C3FfacultyAt10[0]==='Dr. ASKS'){
      numAt10=[]
   }
   if(P3FfacultyAt11[0]===prof[1]||C3FfacultyAt11[0]===prof[1]||C3FfacultyAt11[0]===prof3[0]||CFfacultyAt11===prof3[1]||C3FfacultyAt11[0]==='Dr. ASKS'){
    numAt11=[]
 }
 if(P3FfacultyAt12[0]===prof[1]||C3FfacultyAt12[0]===prof[1]||C3FfacultyAt12[0]===prof3[0]||CFfacultyAt12===prof3[1]||C3FfacultyAt12[0]==='Dr. ASKS'){
  numAt12=[]
}
if(P3FfacultyAt03[0]===prof[1]||C3FfacultyAt03[0]===prof[1]||C3FfacultyAt03[0]===prof3[0]||CFfacultyAt03===prof3[1]||C3FfacultyAt03[0]==='Dr. ASKS'){
  numAt03=[]
}
if(P3FfacultyAt04[0]===prof[1]||C3FfacultyAt04[0]===prof[1]||C3FfacultyAt04[0]===prof3[0]||CFfacultyAt04===prof3[1]||C3FfacultyAt04[0]==='Dr. ASKS'){
  numAt04=[]
}
if(P3FfacultyAt05[0]===prof[1]||C3FfacultyAt05[0]===prof[1]||C3FfacultyAt05[0]===prof3[0]||CFfacultyAt05===prof3[1]||C3FfacultyAt05[0]==='Dr. ASKS'){
  numAt05=[]
}


if(P4FfacultyAt9.length>0){
  if(P4FfacultyAt9[0]==='Dr. UDD'){
    numAt9=['Dr. UDD']
  }else if(P4FfacultyAt9[0]==='Dr. Biswas'){
    numAt9=['Dr. Biswas']
  }else{
    numAt9= prof3.filter((item) => { 
        return FfacultyAt9.indexOf(item) === -1 
...
if(P4FfacultyAt10.length>0){
    if(P4FfacultyAt10[0]==='Dr. UDD'){
      numAt10=['Dr. UDD']
    }else if(P4FfacultyAt10[0]==='Dr. Biswas'){
      numAt10=['Dr. Biswas']
    }else{
      numAt10= prof3.filter((item) => { 
          return FfacultyAt10.indexOf(item) === -1 
  ...
  if(P4FfacultyAt11.length>0){
    if(P4FfacultyAt11[0]==='Dr. UDD'){
      numAt11=['Dr. UDD']
    }else if(P4FfacultyAt11[0]==='Dr. Biswas'){
      numAt11=['Dr. Biswas']
    }else{
      numAt11= prof3.filter((item) => { 
          return FfacultyAt11.indexOf(item) === -1 
  ...
  if(P4FfacultyAt12.length>0){
    if(P4FfacultyAt12[0]==='Dr. UDD'){
      numAt12=['Dr. UDD']
    }else if(P4FfacultyAt12[0]==='Dr. Biswas'){
      numAt12=['Dr. Biswas']
    }else{
      numAt12= prof3.filter((item) => { 
          return FfacultyAt12.indexOf(item) === -1 
  ...
  if(P4FfacultyAt03.length>0){
    if(P4FfacultyAt03[0]==='Dr. UDD'){
      numAt03=['Dr. UDD']
    }else if(P4FfacultyAt03[0]==='Dr. Biswas'){
      numAt03=['Dr. Biswas']
    }else{
      numAt03= prof3.filter((item) => { 
          return FfacultyAt03.indexOf(item) === -1 
  ...
  if(P4FfacultyAt04.length>0){
    if(P4FfacultyAt04[0]==='Dr. UDD'){
      numAt04=['Dr. UDD']
    }else if(P4FfacultyAt04[0]==='Dr. Biswas'){
      numAt04=['Dr. Biswas']
    }else{
      numAt04= prof3.filter((item) => { 
          return FfacultyAt04.indexOf(item) === -1 
  ...
  if(P4FfacultyAt05.length>0){
    if(P4FfacultyAt05[0]==='Dr. UDD'){
      numAt05=['Dr. UDD']
    }else if(P4FfacultyAt05[0]==='Dr. Biswas'){
      numAt05=['Dr. Biswas']
    }else{
      numAt05= prof3.filter((item) => { 
          return FfacultyAt05.indexOf(item) === -1 
    ...
    numAt9=[C4FfacultyAt9[0]]    
    numAt10=[C4FfacultyAt10[0]]
    numAt11=[C4FfacultyAt11[0]]
    numAt12=[C4FfacultyAt12[0]]
    numAt03=[C4FfacultyAt03[0]]
    numAt04=[C4FfacultyAt04[0]]
    numAt05=[C4FfacultyAt05[0]]
  }
}
